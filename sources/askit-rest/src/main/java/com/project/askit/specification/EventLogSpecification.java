...
public class EventLogSpecification implements org.springframework.data.jpa.domain.Specification<EventLog> {

    private final SearchCriteria searchCriteria;

    public EventLogSpecification(SearchCriteria searchCriteria) {
