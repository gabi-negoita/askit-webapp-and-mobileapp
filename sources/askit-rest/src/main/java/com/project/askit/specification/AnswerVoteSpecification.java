...
public class AnswerVoteSpecification implements org.springframework.data.jpa.domain.Specification<AnswerVote> {

    private final SearchCriteria searchCriteria;

    public AnswerVoteSpecification(SearchCriteria searchCriteria) {
        this.searchCriteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<AnswerVote> root,
                                 CriteriaQuery<?> query,
